...
\begin{example}{Say hello to a player}
    \ic{/send-message \player Hello \ph{player:name}}
\end{example}

\LevelThree{/send-broadcast}

\begin{example}{Say hello to all players}
    \ic{/send-broadcast Hello \ph{player:name}}
\end{example}

\LevelThree{/send-actionbar}

\begin{example}{Say hello to a player}
    \ic{/send-actionbar \player Hello \ph{player:name}}
\end{example}
...
\begin{example}{A simple exapmle}
    \ic{/send-bossbar \player Hello World}
\end{example}
...
\begin{example}{Send custom text as a book}
    \ic{/send-custom as-book \player guide --author "alice" --title "<rb>The Guide" --giveBook true --openBook true}
\end{example}
