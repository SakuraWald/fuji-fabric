...
\begin{Configuration}
    \item[cron]{
        The cron used to define the job to trigger \cmd{/cleaner clean}.
    }

    \item[key2age]{
        The key is translatable key, which you can query in \href{https://github.com/sakurawald/fuji/blob/dev/.github/files/en_us.json}{en\_us.json language file in minecraft 1.21.} \\
