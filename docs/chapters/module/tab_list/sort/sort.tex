...
\begin{example}{Set a weight in a group}
    \ttt{Issue the command }\cmd{/lp group default meta set fuji.tab\_list.sort.weight 1}\\
    After you set a new weight, you should issue \cmd{/fuji reload} or re-connect to refresh the tab-list.
\end{example}
